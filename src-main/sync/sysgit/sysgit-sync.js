...
class SysgitSync {
  ...
  async hardPush(){
    ...
    outputConsole.appendLine('START SYSGIT CHECKOUT');
    ...
    outputConsole.appendLine('');
    outputConsole.appendLine('  git server_url:     ' + this._config.git_server_url);
    outputConsole.appendLine('  git branch:       ' + this._config.branch);
    outputConsole.appendLine('  git email:        ' + this._config.email);
    outputConsole.appendLine('-----------------');
    outputConsole.appendLine('');
  ...
  _fullGitHubUrl(){
    return this._config.git_server_url;
  }
