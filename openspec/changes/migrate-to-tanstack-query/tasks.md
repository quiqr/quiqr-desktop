...
**IMPORTANT**: All tasks in this file MUST have checkboxes `- [ ]` or `- [x]` to track implementation status.
...
- [x] **Goal**: Identify all types currently scattered between frontend and backend
- [x] **Validation**: Document created with type locations and dependencies
- [x] **Dependencies**: None
- [x] **Status**: Completed in exploration phase
...
- **Files**:
  ...
  - [ ] `packages/frontend/src/containers/SiteLibrary/NewSlashImportSiteDialog.tsx`
