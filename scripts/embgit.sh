...
get_binaries() {
  case "$PLATFORM" in
    darwin/386) BINARIES="embgit" ;;
    darwin/amd64) BINARIES="embgit" ;;
    darwin/arm64) BINARIES="embgit" ;;
    darwin/armv6) BINARIES="embgit" ;;
    linux/386) BINARIES="embgit" ;;
    linux/amd64) BINARIES="embgit" ;;
    linux/arm64) BINARIES="embgit" ;;
    linux/armv6) BINARIES="embgit" ;;
    windows/386) BINARIES="embgit" ;;
    windows/amd64) BINARIES="embgit" ;;
    windows/arm64) BINARIES="embgit" ;;
    windows/armv6) BINARIES="embgit" ;;
    *)
...
http_download_curl() {
  ...
  header=$3
  if [ -z "$header" ]; then
    code=$(curl -L -w '%{http_code}' -sL -o "$local_file" "$source_url")
  else
    code=$(curl -L -w '%{http_code}' -sL -H "$header" -o "$local_file" "$source_url")
  fi
  if [ "$code" != "200" ]; then
