...
let fields: Array<any> = [
    ...
    { key: 'boolean-section', title:'Boolean', type:'section', groupdata:false, fields:[
        { key:'boolean', title:'boolean', type:'boolean' }
    ]},
    { key: 'bundle-manager-section', title:'Bundle Manager', type:'section', groupdata:false, fields:[
        { key:'bundle-manager-images', title:'Bundle Manager: Images', type:'bundle-manager', path: 'images', extensions: ['png', 'jpg', 'jpeg' ], fields:[
            { key:'featured', title:'Featured', type:'boolean' },
            { key:'thumb', title:'Thubmanil', type:'bundle-image-thumbnail' },    
        ]},
        { key:'bundle-manager-docs', title:'Bundle Manager: Documents', type:'bundle-manager', path: 'docs', extensions: ['txt', 'docx', 'ttf', 'html'], fields:[
            { key:'featured', title:'Featured', type:'boolean' }
        ]}
    ]},
    ...
    { key:'hidden-section', title:'Hidden (don\'t expect a visible content)', type:'section', groupdata:false, fields:[
        { key:'hidden', default:'hidden-default-value', type:'hidden'}
    ]},
    { key:'leaf-array-section', title:'Leaf Array', type:'section', groupdata:false, fields:[
        { key:'leaf-array', type:'leaf-array', field:{
            key:'date', title:'Date', type:'date'
        }}
    ]},
    { key:'markdown-section', title:'Markdown', type:'section', groupdata:false, fields:[
    ...
    { key:'nest-section', title:'Nest', type:'section', groupdata:false, fields:[
        { key:'nest', title:'Nest', type:'nest', groupdata:true, fields:[
            { key:'number', title:'Nested Number', type:'number' }
        ]}
    ]},
    { key:'number-section', title:'Number', type:'section', groupdata:false, fields:[
        { key:'number', title:'Number', type:'number' }
    ]},
    { key: 'readonly-section', title:'Readonly', type:'section', groupdata:false, fields:[
        { key:'readonly', title:'Readonly', type:'readonly' }
    ]},
    { key:'section-section', title:'Section', type:'section', groupdata:false, fields:[
        { key:'section', title:'Section', type:'section', groupdata:true, fields:[
